			...
			do {
				...
				foreach ($iterations as $alias => $options) {
					...
					if (empty($options['conditions'])) {
						if ($type === 'belongsTo') {
							...
							$query['joins'][] = array(
								...
								// PROPUESTA - olafrv@gmail.com
								//'table' => is_string($Link) ? $Link : $Link->getDataSource()->fullTableName($Link),
								// PROPUESTA - olafrv@gmail.com
					...
					if (empty($options['table'])) {
						// MODIFICACION - olafrv@gmail.com - CakePHP 1.3.13
						// Resolver problema 'prefijo-'prefijo-tabla'' al usar links en un find!!!
